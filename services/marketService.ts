...
export const analyzeMarketHistory = (candles: Candle[], h1Candles: Candle[], h4Candles: Candle[]) => {
    ...
    // Note: candles.time is in seconds
    ...
    // Asia Range typically 00:00 - 06:00 UTC (simplified for crypto/fx commonality)
    // Or 20:00 - 00:00 NY time. Let's use 00:00 - 06:00 UTC as a proxy for "Pre-London"
    ...
    for (let i = 20; i < candles.length - 3; i++) {
      ...
      // 2. MANIPULATION DETECTION (TURTLE SOUP / JUDAS)
      // Check PDH/PDL and Asia High/Low Sweeps
